...
-  [Function `fungible_staked_sui_data_mut`](#sui_system_staking_pool_fungible_staked_sui_data_mut)
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_redeem_fungible_staked_sui">redeem_fungible_staked_sui</a>(
    ...
    <b>let</b> fungible_staked_sui_data = pool.<a href="../sui_system/staking_pool.md#sui_system_staking_pool_fungible_staked_sui_data_mut">fungible_staked_sui_data_mut</a>();
    <b>let</b> (
        principal_amount,
        rewards_amount,
...
<pre><code><b>macro</b> <b>fun</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_mul_div">mul_div</a>($a: u64, $mul: u64, $div: u64): u64
</code></pre>
...
<pre><code><b>macro</b> <b>fun</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_mul_div">mul_div</a>($a: u64, $mul: u64, $div: u64): u64 {
    (($a <b>as</b> u128) * ($mul <b>as</b> u128) / ($div <b>as</b> u128)) <b>as</b> u64
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_convert_to_fungible_staked_sui">convert_to_fungible_staked_sui</a>(
    ...
    <b>if</b> (!pool.extra_fields.contains(<a href="../sui_system/staking_pool.md#sui_system_staking_pool_FungibleStakedSuiDataKey">FungibleStakedSuiDataKey</a> {})) {
        pool
            .extra_fields
            .add(
        ...
        <b>let</b> fungible_stake_data = pool.<a href="../sui_system/staking_pool.md#sui_system_staking_pool_fungible_staked_sui_data_mut">fungible_staked_sui_data_mut</a>();
        fungible_stake_data.total_supply = fungible_stake_data.total_supply + <a href="../sui_system/staking_pool.md#sui_system_staking_pool_pool_token_amount">pool_token_amount</a>;
        fungible_stake_data.principal.join(principal);
    };
    <a href="../sui_system/staking_pool.md#sui_system_staking_pool_FungibleStakedSui">FungibleStakedSui</a> {
        id: object::new(ctx),
...
<a name="sui_system_staking_pool_fungible_staked_sui_data_mut"></a>

## Function `fungible_staked_sui_data_mut`



<pre><code><b>fun</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_fungible_staked_sui_data_mut">fungible_staked_sui_data_mut</a>(pool: &<b>mut</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_StakingPool">sui_system::staking_pool::StakingPool</a>): &<b>mut</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_FungibleStakedSuiData">sui_system::staking_pool::FungibleStakedSuiData</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_fungible_staked_sui_data_mut">fungible_staked_sui_data_mut</a>(pool: &<b>mut</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_StakingPool">StakingPool</a>): &<b>mut</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_FungibleStakedSuiData">FungibleStakedSuiData</a> {
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_join_staked_sui">join_staked_sui</a>(self: &<b>mut</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_StakedSui">StakedSui</a>, other: <a href="../sui_system/staking_pool.md#sui_system_staking_pool_StakedSui">StakedSui</a>) {
    <b>assert</b>!(self.<a href="../sui_system/staking_pool.md#sui_system_staking_pool_is_equal_staking_metadata">is_equal_staking_metadata</a>(&other), <a href="../sui_system/staking_pool.md#sui_system_staking_pool_EIncompatibleStakedSui">EIncompatibleStakedSui</a>);
...
<pre><code><b>fun</b> <a href="../sui_system/staking_pool.md#sui_system_staking_pool_is_preactive_at_epoch">is_preactive_at_epoch</a>(pool: &<a href="../sui_system/staking_pool.md#sui_system_staking_pool_StakingPool">StakingPool</a>, epoch: u64): bool {
    ...
    pool.<a href="../sui_system/staking_pool.md#sui_system_staking_pool_is_preactive">is_preactive</a>() || (*pool.activation_epoch.borrow() &gt; epoch)
}
</code></pre>
